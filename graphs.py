...
axs[0].bar(x_pt_knee, runtime_knee, width=bar_width, label='Runtime', color='#d4afb9')
axs[0].bar(x_pt_knee + bar_width, memory_knee, width=bar_width, label='Memory', color='#7ec4cf')
...
axs[1].bar(x_pt_chest, runtime_chest, width=bar_width, label='Runtime', color='#d4afb9')
axs[1].bar(x_pt_chest + bar_width, memory_chest, width=bar_width, label='Memory', color='#7ec4cf')
